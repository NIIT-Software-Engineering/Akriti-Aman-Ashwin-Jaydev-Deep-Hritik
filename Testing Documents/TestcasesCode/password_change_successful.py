...
class PasswordChangeSuccessful(unittest.TestCase):
    def setUp(self):
    ...
    def test_password_change_successful(self):
        ...
        driver.find_element_by_id("id_old_password").send_keys("password123")
        driver.find_element_by_id("id_new_password1").clear()
        driver.find_element_by_id("id_new_password1").send_keys("passcode")
        driver.find_element_by_id("id_new_password2").clear()
        driver.find_element_by_id("id_new_password2").send_keys("passcode")
