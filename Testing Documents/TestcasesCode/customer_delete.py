...
class CustomerDelete(unittest.TestCase):
    def setUp(self):
    ...
    def test_customer_delete(self):
        driver = self.driver
        driver.get(self.base_url + "/custpage/210/")
        ...
        Select(driver.find_element_by_name("action")).select_by_visible_text("Delete selected customers")
